...
public class OctopusCountBigO extends BigOMeasurable implements OctopusCountI{

        private Set<Octopus> octopusHashSet;
        private final OctopusCountI.ArmTexture armTexture[] = {ArmTexture.SLIMY, ArmTexture.SMOOTH , ArmTexture.SLIMY ,ArmTexture.SLIMY, ArmTexture.SMOOTH , ArmTexture.SLIMY ,ArmTexture.SLIMY, ArmTexture.SMOOTH};
        private final OctopusCountI.ArmColor armColor[]= {ArmColor.GRAY,ArmColor.BLACK,ArmColor.RED,ArmColor.GRAY,ArmColor.BLACK,ArmColor.RED,ArmColor.GRAY,ArmColor.BLACK};
        public OctopusCountBigO(){
    ...
    public void execute() {
            for(int i = 0; i<this.n; i++){
                int arms[] = {1,1,1,1,1,1,1,1};
                this.addObservation(i,this.armColor,arms, armTexture);
            }
    ...
    public static class Octopus{
        ...
        public boolean equals(Object o) {
            if (this == o) return true;
            if (o == null || getClass() != o.getClass()) return false;
            OctopusCountBigO count = (OctopusCountBigO) o;
